function overlay(id,text,url) {
    ...
    overlay.setAttribute("style", "background-color: #BCC0CC; position: absolute; left: " + Xpos + "px; top: " + Ypos + "px; border: 2px solid #2a2a2b; width: 300px; padding: 2px; margin: 0;")
